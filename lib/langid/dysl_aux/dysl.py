...
#python dysl.py --train ./dysl/corpora/multiLanguage/trainedCorpus2.obj --corpus ./dysl/corpora/multiLanguage
...
#python dysl.py --list-langs  --model ./dysl/corpora/multiLanguage/trainedCorpus2.obj
def main():
