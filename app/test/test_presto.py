...
class TestPrestoBlueprint(BaseTestCase):
    def setUp(self):
        super().setUp()
    ...
    def test_audio_basic_http_responses_with_doc_id(self):
        ...
        mock_data = {
            "body": {
                "id": "9267623a-0e7c-4609-a728-96bfb91e0ef4",
                ...
                "raw": {
                    ...
                    "doc_id": "9267623a-0e7c-4609-a728-96bfb91e0ef4",
                    "context": {"team_id": 1},
                    "created_at": "2023-10-24T19:34:54.467125",
                    "command": "search",
                    "threshold": 0.0,
                    "per_model_threshold": {},
